...
# **************************************************************************
# *** ONLY FOR DEMONSTRATION PURPOSES IN HOW THE CSV FILES num_words AND ***
# *** unique_words WERE MADE, I figured that using sql operations from   ***
# *** on the cleaned_bible_data.csv file above was better and faster     ***
# **************************************************************************
#     vvv                          vvv                             vvv
#      v                            v                               v
#-----------------------------------------------------------------------------#
